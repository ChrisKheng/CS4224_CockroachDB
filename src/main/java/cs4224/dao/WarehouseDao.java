...
public class WarehouseDao {
    ...
    public WarehouseDao(final QueryResultToEntityMapper queryResultToEntityMapper, final QueryRunner queryRunner,
                        final String schema) {
    ...
    public Warehouse updateAndGetById(double payment, long warehouseId) throws SQLException {
